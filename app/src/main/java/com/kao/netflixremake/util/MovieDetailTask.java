...
public class MovieDetailTask extends AsyncTask<String , Void, MovieDetail> {
    ...
    public void getMovieDetailLoader(MovieDetailLoader movieDetailLoader) {
    ...
    protected MovieDetail doInBackground(String... params) {
        ...
        try {
            ...
            MovieDetail movieDetail = getMovieDetail(new JSONObject(jsonArray));
            in.close();
    ...
    protected void onPostExecute(MovieDetail movieDetail) {
        ...
        Log.d("TESTE", "movieDetail： " + movieDetail);
        dialog.dismiss();
